...
RSpec.describe 'Student account registration', type: :feature, js: true do
  it 'allows the user to register an account' do
    ...
    select 'Student', from: 'user_account_type'
    click_on 'Sign up'
  ...
  context 'when an User with the same email address already exists' do
    before { User.create(email: 'taken@university.com', first_name: 'John', last_name: 'Smith', account_type: :student, password: '@#123fsahfWer') }
